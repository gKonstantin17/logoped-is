...
public enum NotificationMsg {
    ...
    PLANNED_1H("Занятие начнется через час"), // За 15 минут до начала
    STARTING_SOON("Занятие начнется через 15 минут"), // За 15 минут до начала
    ...
    LESSON_DATE_CHANGED("Занятие перенесено на другое время");
